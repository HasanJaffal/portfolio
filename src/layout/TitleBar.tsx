...
export function TitleBar() {
  ...
  return (
    <header className="relative z-10 flex h-11 shrink-0 items-center gap-3 border-b border-border bg-panel px-3">
      ...
      <motion.button
        ...
        className="ml-2 flex flex-1 items-center gap-2 rounded-md border border-border-strong bg-inset px-3 py-1.5 text-left text-muted-dim transition-colors hover:border-lime/40 hover:text-muted sm:max-w-xs"
      >
